import matplotlib
matplotlib.use("TkAgg")  # Pode trocar para "Agg" se necessário
...
# plt.plot(
#     df["round"],
#     df["distributed_accuracy"],
#     marker='^',
#     linewidth=2,
#     label="Distributed Accuracy"
# )
...
plt.title("Comparison of All Accuracy Metrics")
...
plt.title("Comparison of All Loss Metrics")
plt.xlabel("Federated Round")
plt.ylabel("Loss")
